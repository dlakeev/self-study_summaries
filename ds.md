...
* min_samples - запретить алгоритму создавать узлы с числом примеров меньше заданного, чтобы избежать создания тривиальных разбиений и, соответственно, малозначимых правил.
...
### Общие понятия
* **_TP_** — true positive: классификатор верно отнёс объект к рассматриваемому классу.
* **_TN_** — true negative: классификатор верно утверждает, что объект не принадлежит к рассматриваемому классу.
* **_FP_** — false positive: классификатор неверно отнёс объект к рассматриваемому классу.
* **_FN_** — false negative: классификатор неверно утверждает, что объект не принадлежит к рассматриваемому классу.
...
Существует _взевешенный_ показатель, где recall учитывается в $β$ раз более важным чем precision.
